---
title: "Analysis of Queue Time & Service Times"
...
ggplot(appointments[appointments$month!=1&appointments$month!=2&appointments$month!=3,]) + 
  geom_histogram(aes(month), bins=6, binwidth = 0.5) +
  labs(
    title = "Histogram for the Number of Patients in 2020",
...
ggplot(appointments[appointments$month==1|appointments$month==2|appointments$month==3,]) + 
  geom_histogram(aes(month), bins = 3, binwidth = 0.5) +
  labs(
    title = "Histogram for the Number of Patients in 2021",
...
Table: Distributions for each ASA Score
